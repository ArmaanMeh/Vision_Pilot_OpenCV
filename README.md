...
# --- Introduction ---
 ...
 and feature-based detection. It utilizes a Proportional (P) control loop 
...
def send_data_smoothed(d_pan, d_tilt):
    """
    Acts as the Integrator (I-term). Accumulates velocity commands into an absolute 
    position, clamps it, and sends the final position (-1.0 to 1.0) to the Arduino.
    """
